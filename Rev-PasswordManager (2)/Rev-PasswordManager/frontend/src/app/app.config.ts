...
import {
  ...
  BarChart2, Activity, TrendingUp, TrendingDown, Menu, Minus, Clock, ChevronUp, Lightbulb, Download, Upload, Info, HelpCircle, RotateCcw, UploadCloud, FileJson, File, Settings2, FolderOpen, Camera, History, Bell, LogIn, Share2, Mail, Link, Loader2, Users, UserPlus, PlusCircle, Bot, Send,Sparkles,Loader,KeyRound,Bug,CircleX
} from 'lucide-angular';
